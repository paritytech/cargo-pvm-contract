...
#[pvm_contract_macros::contract("StorageTypes.sol", allocator = "pico")]
mod storage_types {
    use super::*;
    ...
    pub fn set_u8(val: u8) {
        let mut buf = [0u8; 32];
        buf[31] = val;
        api::set_storage(StorageFlags::empty(), &KEY_U8, &buf);
    }
    ...
    pub fn set_u16(val: u16) {
        ...
        api::set_storage(StorageFlags::empty(), &KEY_U16, &buf);
    }
    ...
    pub fn set_u32(val: u32) {
        ...
        api::set_storage(StorageFlags::empty(), &KEY_U32, &buf);
    }
    ...
    pub fn set_u64(val: u64) {
        ...
        api::set_storage(StorageFlags::empty(), &KEY_U64, &buf);
    }
    ...
    pub fn set_u128(val: u128) {
        ...
        api::set_storage(StorageFlags::empty(), &KEY_U128, &buf);
    }
    ...
    pub fn set_u256(val: U256) {
        api::set_storage(StorageFlags::empty(), &KEY_U256, &val.to_be_bytes::<32>());
    }
    ...
    pub fn set_bool(val: bool) {
        ...
        api::set_storage(StorageFlags::empty(), &KEY_BOOL, &buf);
    }
    ...
    pub fn set_address(val: Address) {
        ...
        api::set_storage(StorageFlags::empty(), &KEY_ADDRESS, &buf);
    }
    ...
    pub fn set_bytes32(val: [u8; 32]) {
        api::set_storage(StorageFlags::empty(), &KEY_BYTES32, &val);
    }
